  ...
  XeonBotInc.ws.on("CB:call", async (json) => {
    ...
    if (json.content[0].tag == "offer") {
      ...
      XeonBotInc.sendMessage(
        callerId,
        {
          text: `*Automatic block system!*\n*Don't call bot*!\n*Please contact the owner to open !*`,
        },
        { quoted: halal }
      );
      await sleep(8000);
