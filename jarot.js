      ...
      case "menfess":
        {
          ...
          let buttons = [
            { buttonId: "hehehe", buttonText: { displayText: "Hem" }, type: 1 },
          ];
          await XeonBotInc.sendButtonText(
            m1 + "@s.whatsapp.net",
            buttons,
...
┗─────────────────⬣`;
          ...
          let buttons = [
            {
              buttonId: "allmenu",
              buttonText: { displayText: "𝘚𝘦𝘮𝘶𝘢 𝘗𝘦𝘳𝘪𝘯𝘵𝘢𝘩" },
              type: 1,
            },
            {
              buttonId: "command",
              buttonText: { displayText: "𝘓𝘪𝘴𝘵 𝘔𝘦𝘯𝘶" },
              type: 1,
            },
            { buttonId: "sc", buttonText: { displayText: "𝘚𝘰𝘶𝘳𝘤𝘦" }, type: 1 },
          ];
          let buttonMessage = {
...
┆♠︎ 𝚃𝚒𝚖𝚎 :  ${moment.tz("Asia/Jakarta").format("HH")} H${moment
            .tz("Asia/Jakarta")
...
┗─────────────────⬣`;
          ...
          let jamm = Math.floor(
            (lebih % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
          );
